 ...
 */
public class ActivityAllVehiclesActiveBySelectedRoutes extends ActionBarActivity {
    Button vFind;
    Spinner vehicle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        src = intent.getStringExtra("sourceID");
        dest = intent.getStringExtra("destinationID");

        try {
            String query1 = URLEncoder.encode(src, "utf-8");
            String query2 = URLEncoder.encode(dest, "utf-8");
            new ActiveVehiclesAsyncLoader().execute(LINK_URL +"stops/active_vehicles?srcId="+ query1+"&destId="+query2);
        ...
        vFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityAllVehiclesActiveBySelectedRoutes.this,ActivityGoogleMaps.class);
    ...
    private class ActiveVehiclesAsyncLoader extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String data) {
            ...
            try {
                ...
                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ActivityAllVehiclesActiveBySelectedRoutes.this, android.R.layout.simple_spinner_dropdown_item, active_vehicles);
